...
**v1.5**：Introduce a [new WISP subtraction algorithm](https://dx.doi.org/10.1088/1538-3873/acea42) (currently not used for data), update the [WISP template](https://stsci.app.box.com/s/1bymvf1lkrqbdn9rnkluzqk30e8o2bne), optimize mask construction for 1/f removal and background processing, improve the outlier clipping algorithm, fix a bug in the readout noise construction, and resolve background issues in the files before the final drizzle.
